...
<ul class="nav nav-tabs">
  ...
  <li role="presentation" class=<?php echo $t=="socs" ? "active":""?>><a href=<?php echo $pg."socs" ?>>Locked Subreddits</a></li>
  ...
  <li role="presentation" class=<?php echo $t=="sreps" ? "active":""?>><a href=<?php echo $pg."sreps" ?>>Reported Subreddits</a></li>
</ul>
<div class="well">
